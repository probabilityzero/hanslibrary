...
> - [[Domains/The Great Houses/House of El Han/Ministry of Education & Research/GNOSIS, Inc/Scholarly/Scholarly.org\|Scholarly.org]]
> - [[Domains/The Great Houses/House of El Han/Ministry of Technology/Han's Labs/Stack Labs/blackmarket.dev\|blackmarket.dev]]
> 
...
<svg width="512" height="512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="bgGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="35%" stop-color="#E6B7F2"/>
      <stop offset="65%" stop-color="#F7A8C6"/>
      <stop offset="100%" stop-color="#C7B9FF"/>
    </linearGradient>

    <!-- Bookmark gradient -->
    <linearGradient id="bookmarkGradient" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#FF6AA2"/>
      <stop offset="100%" stop-color="#FF3F81"/>
    </linearGradient>
  ...
  <!-- Bookmark -->
  <path
    d="M368 48 H424 V224 L396 200 L368 224 Z"
  ...
  <path
    d="M170 150
       V340
       C170 360 180 370 200 370
       H300
       C315 370 320 360 320 350
       C320 340 315 330 300 330
       H220
       V150
       C220 135 210 125 195 125
       C180 125 170 135 170 150 Z"
    fill="#FFFFFF"
    filter="url(#softShadow)"
  />
</svg>
...
<svg width="512" height="512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Dark background -->
  <rect width="512" height="512" fill="#1E1E24"/>
